      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 w-14 h-14 bg-indigo-600 hover:bg-indigo-500 rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(79,70,229,0.4)] border border-indigo-400/30 z-50 text-white transition-colors"
          >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className={`fixed bottom-6 right-6 z-50 bg-zinc-900/90 backdrop-blur-xl border border-zinc-800 shadow-2xl rounded-2xl flex flex-col overflow-hidden transition-all duration-300 ${
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-sm font-bold text-zinc-100 flex items-center gap-2">
                    Copiloto
                    <span className="px-1.5 py-0.5 rounded text-[9px] font-black uppercase tracking-wider bg-indigo-500/20 text-indigo-400">
                      BETA
                    </span>
                  </h3>
                  <p className="text-[10px] text-emerald-400 font-medium">Online e analisando contas</p>
                </div>
              </div>
            ...
            <div className="p-4 border-t border-zinc-800 bg-zinc-900/80">
              ...
              >
                <input
                  ...
                  className="flex-1 bg-zinc-950 border border-zinc-800 rounded-xl px-4 py-3 pr-12 text-sm text-zinc-100 placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 transition-all"
                  disabled={isLoading}
                />
                <button
                  type="submit"
