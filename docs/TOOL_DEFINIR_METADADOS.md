...
```json
{
  ...
  "captions": "Você sabia que as galinhas podem ser suas melhores aliadas na horta? 🐔🌿 Elas controlam pragas e adubam o solo de forma natural! #hortaorganica #galinhas #sustentabilidade"
}
```

## 2. Descrição da Ferramenta para o n8n
*Use este texto na descrição da ferramenta no Agente:*
> "Atualiza o título, tema e a legenda (captions) do post no banco de dados. Deve ser chamada assim que o objetivo do vídeo for definido na conversa."
...
- **Copywriting:** A legenda já estará pronta no banco de dados assim que a conversa com o Arquiteto terminar.
